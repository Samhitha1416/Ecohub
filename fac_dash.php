        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Dashboard Facilities</h1>
                        ...
                        <div class="card-body">
                            <div class="jumbotron jumbotron-fluid bg-info">
                                <div class="container text-sm-center pt-3">
                                    <h1 class="display-2 hidden-sm-down">
                                    
                                    Ecoreco Recycling Pvt. Ltd
                                    </h1>
                                    <br>
                                    
                                    <p class="lead">ewaste@ewri.in</p>
                                    <p class="lead">www.ewri.in</p>
                                    <p class="lead">
                                        Fantasia Country</p>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body">Total Cost of e-waste</div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-warning text-white mb-4">
                                <div class="card-body">Quantity of e-waste(kg)</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <h1>
                                    <?php
